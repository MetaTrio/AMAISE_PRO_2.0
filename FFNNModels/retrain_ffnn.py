...
@click.option(
    ...
    type=str,
    required=False,
    default="models/initialFFNN5mer",
)
...
def main(input, labels, model, pre_model, output, batch_size, epoches, learning_rate):
    ...
    model.module.fc4 = nn.Linear(model.module.fc4.in_features, 6)

    for param in model.parameters():
        param.requires_grad = False
    for param in model.module.fc4.parameters():
